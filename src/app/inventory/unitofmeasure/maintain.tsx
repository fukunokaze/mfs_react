            ...
            <div className="mx-auto mt-5" style={{ maxWidth: '28rem' }}>
                <form onSubmit={onSubmit}>
                    ...
                    <div className="mb-3 row align-items-center">
                        ...
                        <div className="col-8">
                            <select id='UomType' name='UomType' className="form-select" defaultValue={props.data.uomType}>
                    ...
                    <div className="mb-3 row align-items-center">
                        ...
                        <div className="col-8">
                            <select id='UomCategory' name='UomCategory' className="form-select" defaultValue={props.data.uomCategory}>
